...
@RedisHash("warehouse_types")
public class WarehouseTypeRedis {
    @Id
    int type_id;
    ...
    public WarehouseTypeRedis(int type_id, String type_name, int type_small_quantity, int type_med_quantity, int type_huge_quantity) {
